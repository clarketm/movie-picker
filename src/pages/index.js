                ...
                <form className="container" onSubmit={this.handleSubmit}>
                    ...
                    <div className="row text-right">
                        <div className="column">
                            ...
                            <input name="custom" id="custom" onChange={this.handleChange} type="checkbox" value={this.state.custom}/>
                        </div>
                    </div>
                    ...
                    <div>
                            ...
                            <div className="column">
                                ...
                                <select name="genre" id="genre" onChange={this.handleChange} value={this.state.genre}>
                                    {Object.keys(GENRES).map((key, index) => (
                                        <option key={key} value={GENRES[key]}>{key}</option>
                                    ))}
                                </select>
                            </div>
                            <div className="column">
                                <label for="movies">Movies?</label>
                                <input name="movies" id="movies" onChange={this.handleChange} type="checkbox" value={this.state.movies}/>
                                <br/>
                            </div>

                            <div className="column">
                                <label for="movies">TV Shows?</label>
                                <input name="tv" id="tv" onChange={this.handleChange} type="checkbox" value={this.state.tv}/>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="column">
                                ...
                                <select name="lowrating" id="lowrating" onChange={this.handleChange} value={this.state.lowrating}>
                            ...
                            <div className="column">
                                ...
                                <select name="highrating" id="highrating" onChange={this.handleChange} value={this.state.highrating}>
                                    {RATINGS.map((value, index) => (
                                        <option key={index} value={value}>{value}</option>
                                    ))}
                                </select>
                        ...
                        <div className="row">
                            <div className="column">
                                ...
                                <input name="director" id="director" onChange={this.handleChange} type="text" value={this.state.director}/>
                            </div>

                            <div className="column">
                                <label for="actor">Actor</label>
                                <input name="actor" id="actor" onChange={this.handleChange} type="text" value={this.state.actor}/>
                            </div>

                            <div className="column">
                                <label for="keyword">Keyword</label>
                                <input name="keyword" id="keyword" onChange={this.handleChange} type="text" value={this.state.keyword}/>
                            </div>
                        </div>
                    </div> ||
                        ...
                        <div className="column">
                            ...
                            <select name="profile" id="profile" onChange={this.handleChange} value={this.state.profile}>
                                {Object.keys(PROFILES).map((key, index) => (
                                    <option key={key} value={PROFILES[key]}>{key}</option>
                                ))}
                            </select>
                        </div>
                    </div>}
